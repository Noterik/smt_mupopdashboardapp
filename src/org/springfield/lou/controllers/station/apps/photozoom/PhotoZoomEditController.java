...
*/
package org.springfield.lou.controllers.station.apps.photozoom;
...
public class PhotoZoomEditController extends Html5Controller{
	
	private String tab="setting";
	private String valuelist="appeditor_content_url";
	
	public PhotoZoomEditController() {
	...
	private void fillSubPage(String tab) {
		if (tab.equals("setting")) {
			...
			screen.get("#subeditor").append("div","appeditor_subeditor_mainapp_photozoom",new PhotoZoomMainAppController());
		}
	}
