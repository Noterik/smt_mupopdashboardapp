...
public class WhatWeThinkMainAppController extends Html5Controller{
	
	String selecteditem;
	String selectedmask;
	
	public WhatWeThinkMainAppController() {
	...
	public void onItemQuestionSelected(Screen s,JSONObject data) {
		...
		screen.get("#screen").append("div","appeditor_whatwethinkquestion",new WhatWeThinkQuestionController());
	}
