...
*/
package org.springfield.lou.controllers.station.apps.slideshow;
...
public class SlideShowEditController extends Html5Controller{
	...
	private void fillSubPage(String tab) {
		if (tab.equals("setting")) {
			...
			screen.get("#subeditor").append("div","appeditor_subeditor_mainapp_photoexplore",new SlideShowMainAppController());
		}
	}
