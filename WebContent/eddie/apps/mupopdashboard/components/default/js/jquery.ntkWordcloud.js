(function($) {
  ...
  $.ntkWordcloud.defaults = {
    words: [],
    gravity: 1, //Decides how quick the words will go to the center of gravity
    wordDefaults: {
      text: "Lorum",
      color: "#ffffff", //Can either be a HEX string or "random" <- means random color will be generated
      fontSize: 24,
      fontSizeIncrease: 1, //How much will the fontSize be increased if the word already exists,
      fontFamily: 'Helvetica'
    },
    defaultCharge: -2000, //Decides if nodes are attracted to each or not, positive means attraction, negative means repel
    chargeMultiplier: -300 //Charge is calculated from fontSize like this (fontSize * chargeMultiplier)
  };
